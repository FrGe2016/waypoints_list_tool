...
output_file_path = rospkg.RosPack().get_path('waypoints_list_tool')+"/saved_path/pose.csv"
waypoints = []
...
class GetPath(State):
    def __init__(self):
        ...
        self.posearray_topic = rospy.get_param('~posearray_topic','/waypoints')
        self.polygone_publisher = rospy.Publisher('/waypoint_editor/path', PolygonStamped, queue_size=1)
    ...
    def initialize_path_queue(self):
        ...
        # publish path so that you can see them the change in rviz, etc.
        self.polygone_publisher.publish(convert_PoseWithCovArray_to_Polygone(waypoints))    #***
